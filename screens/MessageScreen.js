...
import { View, SafeAreaView, TextInput, Button, KeyboardAvoidingView, TouchableWithoutFeedback, Keyboard, FlatList } from 'react-native';
			...
			>
				...
				>
					<TextInput
						...
						value={input}
					/>
					<Button onPress={sendMessage} title="Enviar" color="#cd853f" />
				</View>
			</KeyboardAvoidingView>
		</SafeAreaView>
	);
